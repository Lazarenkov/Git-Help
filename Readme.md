...
> 1. [Добавление  репозитория](#Добавление-репозитория)
> 2. [Удаление  репозитория](#Удаление-репозитория)
> 3. [Работа с remote-репозиторием](#Работа-с-remote-репозиторием)
> 4. [Инфо о репозитории](#Инфо-о-репозитории)
> 5. [Работа с содержимым репозитория](#Работа-с-содержимым-репозитория)
...
* `git remote add name https://www...` - добавить ремоут репозиторий *name* и привязку к нему
